...
**Komitmen waktu dan ritme.** Lab dikerjakan pada minggu yang sama dengan bacaannya - menundanya berarti menunda pemahaman, dan minggu berikutnya akan terasa seperti deretan istilah yang tidak tersambung. Mulai W4, satu Komponen Mandiri mingguan dipilih dari empat jalur (Implementasi, Analisis, Desain, Arsitektur Baru), dicatat di [`notebooks/portofolio_mandiri.ipynb`](template_repo/notebooks/portofolio_mandiri.ipynb), lalu dipresentasikan 10 menit di awal sesi berikutnya. Selesaikan tugas mingguan sebelum sesi berikutnya.
