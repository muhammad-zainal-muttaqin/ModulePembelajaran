...
> *Capstone bukan ujian terakhir - ia adalah pameran pertama. Empat minggu yang memaksa kamu merangkai ulang semua yang telah dipelajari menjadi satu cerita yang kamu pertanggungjawabkan dari awal hingga akhir.*

---

## 0. Peta Bab

Bab ini memandu kamu menyusun proyek capstone 4 minggu yang mengintegrasikan minimal enam dari sembilan kompetensi modul dan memperlihatkan keempat sikap riset - *curiosity*, *rigor*, *skepticism*, *ownership* - dalam satu karya yang padat. Kamu akan memilih satu dari tiga template proyek yang telah diuji kompleksitasnya, mengikuti timeline mingguan yang realistis, dan menghasilkan tiga *deliverable* yang dapat dievaluasi: repository lengkap, laporan 6-8 halaman, serta demo yang bisa diklik. Bab ini sekaligus menjelaskan kriteria penerimaan capstone, cara memetakan pekerjaanmu ke rubrik Bab 11, dan batasan sehat yang menjaga proyek tetap selesai tepat waktu alih-alih "hampir selesai" dengan kualitas yang meragukan.

---

## 1. Motivasi: Proyek yang Tidak Ditanya Ulang

Bayangkan setelah lulus, kamu melamar posisi riset atau program magang. Pertanyaan yang paling sering muncul dalam wawancara bukan "IPK kamu berapa?" - pertanyaan itu adalah "ceritakan satu proyek yang kamu banggakan dan jelaskan keputusan-keputusan yang kamu ambil di dalamnya."
...
Capstone ini dirancang agar kamu bisa memberi jawaban jenis kedua - tidak hanya tentang proyek capstone, tetapi tentang proyek apapun yang kamu kerjakan sesudahnya. Disiplinnya menjadi disiplinmu.
...
**Menghasilkan artefak publik.** Repository yang orang lain bisa clone dan jalankan; laporan yang orang lain bisa baca mandiri; demo yang orang lain bisa coba. Jika semua hanya ada di laptop kamu, capstone gagal memenuhi ownership yang sejati.
...
3. **Metode (3 menit).** Tunjukkan gambar: arsitektur, alur data, apa yang *baru* (intervensi kamu).
...
Tip: latihan dua kali, rekam sekali, tonton. Kamu akan melihat sendiri kalimat-kalimat yang tidak perlu.
...
**Pitfall 3 - Demo dibuat untuk mengesankan, bukan menginformasikan.** Interface cantik, tetapi tidak menunjukkan kelemahan model. *Cara deteksi:* demo kamu harus memudahkan menemukan contoh di mana model *gagal* - ini tanda kejujuran.
...
**Pitfall 6 - Pembimbing baru mendengar masalah di minggu 4.** "Pak, ternyata saya tidak bisa menjalankan X sejak minggu 2." Checkpoint mingguan dirancang mencegah ini. *Cara deteksi:* jika kamu menyembunyikan masalah dari pembimbing, kamu sedang merampas bantuan yang berhak kamu dapatkan.

---

## 5. Lab Hands-on

Capstone adalah lab itu sendiri - tidak ada notebook tambahan. Sebagai gantinya, pastikan selama 4 minggu kamu menghasilkan artefak berikut di folder proyekmu:
...
2. Di minggu ke-2, bandingkan timeline aktual vs rencana. Di mana kamu paling lambat? Apa yang kamu pelajari tentang cara kamu bekerja - apakah kamu cenderung terlalu optimis di setup, terlalu lama di polish, atau terlalu banyak eksperimen paralel?
3. Setelah presentasi akhir, refleksi satu halaman: keputusan desain mana yang paling sulit? Di mana kamu paling tergoda menyimpang dari pre-reg? Apa yang akan kamu lakukan berbeda di proyek riset berikutnya?
...
- **"Reproducibility Checklist for ML"** (NeurIPS/ICML). Centang tiap poin di repo akhir kamu; yang tidak terpenuhi, catat alasannya di limitations.
...
- **Papers with Code - "State of the Art"** halaman untuk dataset yang kamu pakai. Kalau kamu belum tahu top-3 hasil saat ini, kamu belum cukup memetakan konteks.

---

*Bab 11 (Rubrik Penilaian) telah ditulis sebelum capstone - baca ulang sekarang dengan proyekmu di tangan, dan gunakan rubrik sebagai self-check. Bab 12 berisi lampiran: glosarium ID↔EN, checklist, serta template laporan dan pre-registration yang dapat langsung kamu pakai.*